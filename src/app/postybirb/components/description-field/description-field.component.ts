...
import { DescriptionRequirements } from '../../models/website-description-requirements.model';
...
export class DescriptionFieldComponent extends BaseControlValueAccessorComponent implements OnInit, OnDestroy, AfterViewInit, ControlValueAccessor {
  ...
  ngOnInit() {
    if (this.formControlName && DescriptionRequirements[this.formControlName]) {
      this.maxLength = DescriptionRequirements[this.formControlName].maxLength || this.maxLength;
    }
