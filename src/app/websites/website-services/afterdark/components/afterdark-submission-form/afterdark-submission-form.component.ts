...
@Component({
  selector: 'afterdark-submission-form',
  templateUrl: './afterdark-submission-form.component.html',
  styleUrls: ['./afterdark-submission-form.component.css'],
  providers: [{ provide: BaseWebsiteSubmissionForm, useExisting: forwardRef(() => AfterDarkSubmissionForm) }],
  host: HOST_DATA
})
export class AfterDarkSubmissionForm extends BaseWebsiteSubmissionForm implements OnInit, AfterViewInit {
