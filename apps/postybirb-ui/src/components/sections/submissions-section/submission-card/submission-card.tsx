    ...
    const cardClassName = useMemo(
      () =>
        cn(['postybirb__submission__card', className], {
          ...
          'postybirb__submission__card--detailed': !isCompact,
        }),
      [isSelected, submission.isScheduled, isCompact, className],
    );
    ...
    const cardContent = (
      ...
      >
        ...
        >
          ...
          <Stack gap={6} className="postybirb__submission__card_body">
            <Group gap="xs" wrap="nowrap" align="flex-start">
              ...
              <Stack gap={4} className="postybirb__submission__card_content">
                ...
                />
                <SubmissionBadges submission={submission} />
              </Stack>
